CREATE DATABASE  IF NOT EXISTS `sicat` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `sicat`;
...
INSERT INTO `tb_encargados` VALUES (1,'Encargado1','Apellido1','Apellido1',1),(2,'Encargado2','Apellido2','Apellido2',2),(3,'Encargado3','Apellido3','Apellido3',3),(4,'Encargado4','Apellido4','Apellido4',4),(5,'Encargado5','Apellido5','Apellido5',5),(6,'admin','apellido pat','apellido mat',6),(7,'Juan','Perez','Lopez',7);
...
INSERT INTO `tb_encargados_detalle` VALUES (1,1,1),(2,2,2),(3,3,3),(4,4,4),(5,5,5),(1,11,1),(1,12,1),(6,12,1),(6,12,2),(7,13,3);
...
INSERT INTO `tb_pertenece` VALUES (1,13,1,1,23),(2,0,1,1,24),(3,0,1,2,25),(4,0,1,1,26),(5,0,1,1,27);
...
INSERT INTO `tb_usuarios` VALUES (1,'Usuario1','14380f7b75db64fad3af96844bcf95f56306273d',1,'cadena_qr_1','imagen_qr_1','202310691@itslerdo.edu.mx'),(2,'Usuario2','contraseña2',2,'cadena_qr_2','imagen_qr_2','202310691@itslerdo.edu.mx'),(3,'Usuario3','contraseña3',1,'cadena_qr_3','imagen_qr_3','202310691@itslerdo.edu.mx'),(4,'Usuario4','contraseña4',2,'cadena_qr_4','imagen_qr_4','202310691@itslerdo.edu.mx'),(5,'Usuario5','contraseña5',1,'cadena_qr_5','imagen_qr_5','202310691@itslerdo.edu.mx'),(6,'admin','contra',1,'AQUI VA LA CADENA DEL QR','RUTA DEL QR','202310691@itslerdo.edu.mx'),(7,'Carlos','password123',2,'cadena_qr','ruta/imagen_qr','carlos@example.com');
...
/*!50003 DROP PROCEDURE IF EXISTS `sp_ActualizarHoras` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_ActualizarHoras`(
    IN _id_encargado INT,
    IN _id_pertenece INT,
    IN _horas INT
)
BEGIN
    DECLARE _actividad INT;
    
    -- Verificar que el encargado pertenezca a la actividad en tb_encargados_detalle
    SELECT Id_actividad_fk INTO _actividad
    FROM tb_encargados_detalle
    WHERE Id_encargado_fk = _id_encargado
    LIMIT 1;
    
    -- Si el encargado pertenece a la actividad, proceder
    IF _actividad IS NOT NULL THEN

        -- Actualizar las horas en la tabla tb_pertenece
        UPDATE tb_pertenece
        SET Horas = _horas
        WHERE Id_pertenece_pk = _id_pertenece;

        -- Si las horas acumuladas son 20 o más, cambiar el estado a inactivo
        IF _horas >= 20 THEN
            UPDATE tb_pertenece
            SET Activo = 0
            WHERE Id_pertenece_pk = _id_pertenece;
        END IF;
    ELSE
        SELECT message as 'Encargado no pertenece a la actividad';
    END IF;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_Datos_Perfil` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_Datos_Perfil`(
    IN _id_usuario INT
)
BEGIN
    SELECT
	...
	INNER JOIN tb_encargados AS e ON u.id_usuario_pk = e.id_usuario_fk
	INNER JOIN tb_encargados_detalle AS eu ON e.Id_encargado_pk = eu.Id_encargado_fk
	INNER JOIN tb_actividades AS a ON a.Id_actividad_pk = eu.Id_actividad_fk
	WHERE u.id_usuario_pk = _id_usuario
	GROUP BY e.nombre, e.Ap_paterno, e.Ap_materno, u.correo;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_Horarios_perfil` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_Horarios_perfil`(
    IN _id_usuario INT
)
BEGIN
    ...
    inner join tb_encargados as e on e.Id_encargado_pk = ed.Id_encargado_fk
	where e.Id_usuario_fk = _id_usuario;
...
BEGIN
    ...
    THEN
        SET _es_valido = TRUE;
        SET _Horario = (SELECT id_horario_pk
        FROM tb_horarios AS h
        INNER JOIN tb_encargados_detalle AS ed ON h.Id_horario_pk = ed.Id_horario_fk
        WHERE ed.Id_encargado_fk = _id_encargado
        AND h.Dia = _dia_actual
...
-- Dump completed on 2024-06-12  0:43:37
